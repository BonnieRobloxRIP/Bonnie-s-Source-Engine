...
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 1 if block ^6 ^2 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR1V2M1 ^-3 ^2 ^4
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 3 if block ^6 ^2 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR1V2M1a ^-3 ^2 ^4
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 5 if block ^6 ^2 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR1V2M1b ^-3 ^2 ^4
...
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 1 if block ^-6 ^3 ^3 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="south"] run structure load mystructure:EMR1V2M1 ^-3 ^2 ^-5
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 3 if block ^-6 ^3 ^3 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="south"] run structure load mystructure:EMR1V2M1a ^-3 ^2 ^-5
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 5 if block ^-6 ^3 ^3 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="south"] run structure load mystructure:EMR1V2M1b ^-3 ^2 ^-5
...
# // Button 3
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B3 easy matches 0 if block ^-6 ^3 ^-3 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="north"] run structure load mystructure:EMR1V2M2 ^-6 ^4 ^-1 0_degrees none block_by_block 1
...
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B4 easy matches 0 if score R1B4a easy matches 1 if block ^6 ^11 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR1V2M3 ^-5 ^5 ^-6
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B4 easy matches 0 if score R1B4a easy matches 4 if block ^6 ^11 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR1V2M3a ^-5 ^5 ^-6
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B4 easy matches 0 if score R1B4a easy matches 7 if block ^6 ^11 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR1V2M3b ^-5 ^5 ^-6
...
# // Button 5
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B5 easy matches 0 if block ^-6 ^16 ^-6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="east"] run structure load mystructure:EMR1V2M4 ^-4 ^13 ^-4 0_degrees none block_by_block 1
...
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B6 easy matches 0 if score R1B6a easy matches 1 if block ^-6 ^18 ^6 brr:flood_button["brr:button_type"="exit","brr:pressed"=true, "minecraft:block_face"="north"] run structure load mystructure:EMR1V2M5 ^6 ^16 ^-3 0_degrees none block_by_block 1
...
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 1 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F1 ~-6 ~2 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 2 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F2 ~-6 ~3 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 3 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F3 ~-6 ~4 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 4 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F4 ~-6 ~5 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 5 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F5 ~-6 ~6 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 6 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F6 ~-6 ~7 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 7 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F7 ~-6 ~8 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 8 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F8 ~-6 ~9 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 9 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F9 ~-6 ~10 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 10 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F10 ~-6 ~11 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 11 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F11 ~-6 ~12 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 12 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F12 ~-6 ~13 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 13 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F13 ~-6 ~14 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 14 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F14 ~-6 ~15 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 15 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F15 ~-6 ~16 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 16 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F16 ~-6 ~17 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score flood1 easy matches 17 if score r1_timer_s easy matches 0 run structure load mystructure:EMR1V2F17 ~-6 ~18 ~-6 0_degrees none block_by_block 1
# // flood end
