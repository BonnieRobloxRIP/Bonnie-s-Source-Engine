...
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score R3B1 easy matches 0 if score R3B1a easy matches 1 if block ^-2 ^5 ^-6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR3V1M1 ^3 ^2 ^
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score R3B1 easy matches 0 if score R3B1a easy matches 2 if block ^-2 ^5 ^-6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR3V1M1a ^3 ^2 ^
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score R3B1 easy matches 0 if score R3B1a easy matches 5 if block ^-2 ^5 ^-6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR3V1M1b ^3 ^2 ^
...
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score R3B2 easy matches 0 if score R3B2a easy matches 1 if block ^5 ^10 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="north"] run structure load mystructure:EMR3V1M1 ^-4 ^9 ^
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score R3B2 easy matches 0 if score R3B2a easy matches 2 if block ^5 ^10 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="north"] run structure load mystructure:EMR3V1M1a ^-4 ^9 ^
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score R3B2 easy matches 0 if score R3B2a easy matches 5 if block ^5 ^10 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="north"] run structure load mystructure:EMR3V1M1b ^-4 ^9 ^
...
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score R3B3 easy matches 0 if score R3B3a easy matches 1 if block ^-6 ^20 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="east"] run structure load mystructure:EMR3V1M2 ^-5 ^18 ^-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score R3B3 easy matches 0 if score R3B3a easy matches 10 if block ^-6 ^20 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="east"] run structure load mystructure:EMR3V1M2a ^-5 ^18 ^-6 0_degrees none block_by_block 1
...
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 3 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F3 ~-6 ~4 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 4 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F4 ~-6 ~5 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 5 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F5 ~-6 ~6 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 6 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F6 ~-6 ~7 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 7 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F7 ~-6 ~8 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 8 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F8 ~-6 ~9 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 9 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F9 ~-6 ~10 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 10 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F10 ~-6 ~11 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 11 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F11 ~-6 ~12 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 12 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F12 ~-6 ~13 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 13 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F13 ~-6 ~14 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 14 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F14 ~-6 ~15 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 15 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F15 ~-6 ~16 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 16 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F16 ~-6 ~17 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 17 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F17 ~-6 ~18 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score flood3 easy matches 18 if score r3_timer_s easy matches 0 run structure load mystructure:EMR3V1F18 ~-6 ~19 ~-6 0_degrees none block_by_block 1
# // flood end
