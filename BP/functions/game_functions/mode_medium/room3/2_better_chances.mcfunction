...
execute as @e[type=brr:flood_room, name=medium_room3] at @s if score loaded3 medium matches 0 if score R3B1P medium matches 4 run setblock ^-6 ^4 ^3 brr:flood_button["brr:button_type"="exit","brr:pressed"=false, "minecraft:block_face"="east"]
...
execute as @e[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 if score R3B1P endless matches 4 run setblock ^-6 ^4 ^3 brr:flood_button["brr:button_type"="exit","brr:pressed"=false, "minecraft:block_face"="east"]
