...
# // Level
execute as @e[type=brr:flood_room, name=medium_room3] at @s if score loaded3 medium matches 0 run structure load "medium/room3/3_electric_tower:MediumRoom3V3" ~-16 ~1 ~-7
# // Exit Room Anchor
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "medium/room3/3_electric_tower:MediumRoom3V3" ~-16 ~1 ~-7
# // - Scores -
# // buttons
