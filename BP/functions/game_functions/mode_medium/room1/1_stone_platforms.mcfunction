# = LOADING =
# // Level
execute as @s[type=brr:flood_room, name=medium_room1] at @s if score loaded1 medium matches 0 run structure load "medium/room1/1_stone_platforms:MediumRoom1V1" ~-7 ~1 ~-14
# // Next Room Anchor
...
execute as @s[type=brr:flood_room, name=medium_room1] at @s if score loaded1 medium matches 0 run scoreboard players add R1B3 medium 0
# // essential
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "medium/room1/1_stone_platforms:MediumRoom1V1" ~-7 ~1 ~-14
# // - Scores -
# // buttons
