...
# // Position 4
execute as @s[type=brr:flood_room, name=medium_room3] at @s if score R3B1 medium matches 0 if score R3B1P medium matches 4 if block ^-6 ^4 ^3 brr:flood_button["brr:button_type"="exit","brr:pressed"=true, "minecraft:block_face"="east"] run scoreboard players add R3B1a medium 1
# // Position 5
