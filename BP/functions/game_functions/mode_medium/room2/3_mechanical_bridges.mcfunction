...
# // Level
execute as @e[type=brr:flood_room, name=medium_room2] at @s if score loaded2 medium matches 0 run structure load "medium/room2/3_mechanical_bridges:MediumRoom2V3" ~-7 ~1 ~-14
# // Next Room Anchor
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "medium/room2/3_mechanical_bridges:MediumRoom2V3" ~-7 ~1 ~-14
# // - Scores -
# // buttons
