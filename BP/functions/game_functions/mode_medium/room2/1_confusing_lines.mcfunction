...
# // Level
execute as @e[type=brr:flood_room, name=medium_room2] at @s if score loaded2 medium matches 0 run structure load "medium/room2/1_confusing_lines:MediumRoom2V1" ~-7 ~1 ~-14
# // Next Room Anchor
...
execute as @e[type=brr:flood_room, name=medium_room2] at @s if score loaded2 medium matches 0 run scoreboard players add R2B2 medium 0
execute as @e[type=brr:flood_room, name=medium_room2] at @s if score loaded2 medium matches 0 run scoreboard players add R2B3 medium 0
execute as @e[type=brr:flood_room, name=medium_room2] at @s if score loaded2 medium matches 0 run scoreboard players add R2B4 medium 0
execute as @e[type=brr:flood_room, name=medium_room2] at @s if score loaded2 medium matches 0 run scoreboard players add R2B5 medium 0
execute as @e[type=brr:flood_room, name=medium_room2] at @s if score loaded2 medium matches 0 run scoreboard players add R2B6 medium 0
# // essential
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "medium/room2/1_confusing_lines:MediumRoom2V1" ~-7 ~1 ~-14
# // - Scores -
# // buttons
