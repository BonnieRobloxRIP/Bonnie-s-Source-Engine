# = LOADING =
# // Level
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score loaded1 easy matches 0 run structure load mystructure:EasyRoom1V2 ~-7 ~1 ~-7
# // Next Room Anchor
...
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score loaded1 easy matches 0 run scoreboard players add R1B3 easy 0
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score loaded1 easy matches 0 run scoreboard players add R1B4 easy 0
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score loaded1 easy matches 0 run scoreboard players add R1B5 easy 0
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score loaded1 easy matches 0 run scoreboard players add R1B6 easy 0
# // essential
...
# // Level
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load mystructure:EasyRoom1 ~-7 ~1 ~-7
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load mystructure:EasyRoom1V2 ~-7 ~1 ~-7
# // - Scores -
# // buttons
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run scoreboard players add R1B4 endless 0
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run scoreboard players add R1B5 endless 0
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run scoreboard players add R1B6 endless 0
# // essential
