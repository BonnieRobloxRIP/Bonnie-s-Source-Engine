# = LOADING =
# // Level
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score loaded1 easy matches 0 run structure load mystructure:EasyRoom1V3 ~-7 ~1 ~-7
# // - Scores -
# // buttons
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load mystructure:EasyRoom1V3 ~-7 ~1 ~-7
# // - Scores -
# // buttons
