# = SYSTEM RUN =
# - Open entrance door -
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score started3 easy matches 1 if score r3_timer_s easy matches 31 if score r3_timer_ms easy matches 1 run structure load "easy:EasyTunnelDoor2" ~3 ~2 ~-8
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score started3 easy matches 1 if score r3_timer_s easy matches 31 if score r3_timer_ms easy matches 10 run structure load "easy:EasyTunnelDoor3" ~3 ~2 ~-8
...
# - Level title -
execute as @a[tag=easy] at @s if score r3_timer_s easy matches 31 if score r3_timer_ms easy matches 10 if score started3 easy matches 1 run title @a[tag=easy] subtitle §2The Wall
...
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score R3B4 easy matches 0 if score R3B4a easy matches 1 if block ^-5 ^21 ^-6 brr:flood_button["brr:button_type"="exit","brr:pressed"=true, "minecraft:block_face"="down"] run fill ^7 ^19 ^4 ^7 ^19 ^5 air
execute as @s[type=brr:flood_room, name=easy_room3] at @s if score R3B4 easy matches 0 if score R3B4a easy matches 10 if block ^-5 ^21 ^-6 brr:flood_button["brr:button_type"="exit","brr:pressed"=true, "minecraft:block_face"="down"] run fill ^7 ^20 ^4 ^7 ^20 ^5 air
