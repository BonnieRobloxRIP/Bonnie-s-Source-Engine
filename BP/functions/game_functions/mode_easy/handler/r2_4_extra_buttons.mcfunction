...
# - Level title -
execute as @a[tag=easy] at @s if score r2_timer_s easy matches 31 if score r2_timer_ms easy matches 10 if score started2 easy matches 1 run title @a[tag=easy] subtitle §2Extra Buttons
