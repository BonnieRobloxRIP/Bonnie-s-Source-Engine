# = SYSTEM RUN =
# - Open entrance door -
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score started2 easy matches 1 if score r2_timer_s easy matches 21 if score r2_timer_ms easy matches 1 run structure load mystructure:EasyTunnelDoor2 ~-3 ~4 ~-8
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score started2 easy matches 1 if score r2_timer_s easy matches 21 if score r2_timer_ms easy matches 10 run structure load mystructure:EasyTunnelDoor3 ~-3 ~4 ~-8
...
# - Test for buttons -
# // Button 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score R2B1 easy matches 0 if block ^6 ^8 ^-6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR2V1M1 ^-4 ^4 ^-2 0_degrees none block_by_block 1
...
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score R2B2 easy matches 0 if score R2B2a easy matches 1 if block ^-3 ^9 ^3 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR2V1M2a ^6 ^7 ^-2 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score R2B2 easy matches 0 if score R2B2a easy matches 10 if block ^-3 ^9 ^3 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR2V1M2 ^5 ^7 ^-2 0_degrees none block_by_block 1
...
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score R2B3 easy matches 0 if score R2B3a easy matches 1 if block ^-6 ^14 ^-6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="east"] run structure load mystructure:EMR2V1M3b ^-2 ^12 ^4 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score R2B3 easy matches 0 if score R2B3a easy matches 10 if block ^-6 ^14 ^-6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="east"] run structure load mystructure:EMR2V1M3a ^-2 ^12 ^4 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score R2B3 easy matches 0 if score R2B3a easy matches 20 if block ^-6 ^14 ^-6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="east"] run structure load mystructure:EMR2V1M3 ^-2 ^12 ^4 0_degrees none block_by_block 1
...
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score R2B4 easy matches 0 if score R2B4a easy matches 1 if block ^-6 ^15 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR2V1M4a ^4 ^12 ^-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score R2B4 easy matches 0 if score R2B4a easy matches 10 if block ^-6 ^15 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="up"] run structure load mystructure:EMR2V1M4 ^4 ^12 ^-6 0_degrees none block_by_block 1
...
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score R2B5 easy matches 0 if score R2B5a easy matches 1 if block ^-6 ^20 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="down"] run structure load mystructure:EMR2V1M5a ^6 ^18 ^-4 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score R2B5 easy matches 0 if score R2B5a easy matches 10 if block ^-6 ^20 ^6 brr:flood_button["brr:button_type"="parkour","brr:pressed"=true, "minecraft:block_face"="down"] run structure load mystructure:EMR2V1M5 ^5 ^18 ^-4 0_degrees none block_by_block 1
...
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 1 if score r2_timer_s easy matches 3 if score r2_timer_ms easy matches 0 run structure load mystructure:EasyTunnelDoor2 ~-3 ~4 ~-8
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 1 if score r2_timer_s easy matches 3 if score r2_timer_ms easy matches 5 run structure load mystructure:EasyTunnelDoor1 ~-3 ~4 ~-8
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 1 if score r2_timer_s easy matches 3 if score r2_timer_ms easy matches 5 run structure load mystructure:NuhUh ~-3 ~4 ~-13
...
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 3 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F3 ~-6 ~5 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 4 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F4 ~-6 ~6 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 5 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F5 ~-6 ~7 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 6 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F6 ~-6 ~8 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 7 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F7 ~-6 ~9 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 8 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F8 ~-6 ~10 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 9 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F9 ~-6 ~11 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 10 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F10 ~-6 ~12 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 11 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F11 ~-6 ~13 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 12 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F12 ~-6 ~14 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 13 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F13 ~-6 ~15 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 14 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F14 ~-6 ~16 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 15 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F15 ~-6 ~17 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 16 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F16 ~-6 ~18 ~-6 0_degrees none block_by_block 1
execute as @s[type=brr:flood_room, name=easy_room2] at @s if score flood2 easy matches 17 if score r2_timer_s easy matches 0 run structure load mystructure:EMR2V1F17 ~-6 ~19 ~-6 0_degrees none block_by_block 1
# // flood end
...
execute if score r2_transition easy matches 1 as @s[type=brr:flood_room, name=easy_room2] at @s run structure load mystructure:EasyTunnelDoor2 ~3 ~19 ~8
execute if score r2_transition easy matches 10 as @s[type=brr:flood_room, name=easy_room2] at @s run structure load mystructure:EasyTunnelDoor1 ~3 ~19 ~8
