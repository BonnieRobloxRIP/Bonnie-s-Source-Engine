# = SYSTEM RUN =
# - Level title -
execute as @a[tag=easy] at @s if score r1_timer_s easy matches 31 if score r1_timer_ms easy matches 10 if score started easy matches 1 run title @a[tag=easy] subtitle §2Alternative Way
...
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 1 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-7 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 3 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-6 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 5 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-5 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 7 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-4 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 9 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-3 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 11 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-2 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 13 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-1 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 15 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^ ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 17 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^1 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 19 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^2 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 21 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^3 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 23 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^4 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 25 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^5 ^5 ^
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B1 easy matches 0 if score R1B1a easy matches 25 run setblock ^-6 ^5 ^ polished_andesite
...
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 1 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^6 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 3 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^5 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 5 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^4 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 7 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^3 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 9 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^2 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 11 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^1 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 13 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^ ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 15 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-1 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 17 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-2 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 19 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-3 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 21 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-4 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 23 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-5 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 25 run structure load "easy/room1/4_alternative_way:EMR1V4M1" ^-6 ^10 ^ 180_degrees
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 25 run setblock ^6 ^10 ^ polished_andesite
...
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 0 if score R1B2a easy matches 25.. run scoreboard players set R1B2 easy 1
execute as @s[type=brr:flood_room, name=easy_room1] at @s if score R1B2 easy matches 1 if score R1B2a easy matches 25.. run scoreboard players reset R1B2a easy
# // Exit Button
