...
scoreboard players random room2 easy 1 3
...
execute if score loaded2 easy matches 0 as @e[type=brr:flood_room, name=easy_room1] at @s if score room2 easy matches 3 run summon brr:flood_room ~6 ~16 ~22 0 0 * easy_room2
...
execute if score room2 easy matches 3 as @e[type=brr:flood_room, name=easy_room2] at @s run function game_functions/mode_easy/room2/3_mazed_warehouse
...
execute if score loaded3 easy matches 0 as @e[type=brr:flood_room, name=easy_room2] at @s if score room2 easy matches 3 if score room3 easy matches 1 run summon brr:flood_room ^ ^17 ^22 0 0 * easy_room3
execute if score loaded3 easy matches 0 as @e[type=brr:flood_room, name=easy_room2] at @s if score room2 easy matches 3 if score room3 easy matches 2 run summon brr:flood_room ^5 ^17 ^22 0 0 * easy_room3
