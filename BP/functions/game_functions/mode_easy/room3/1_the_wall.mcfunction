...
execute as @s[type=brr:flood_room, name=easy_room2_anchor] at @s if score loaded3 easy matches 0 run summon brr:flood_room ^-3 ^-2 ^8 0 0 * easy_room3
...
# // Level
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "easy:EasyTunnel" ~2 ~1 ~-14
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "easy/room3/1_the_wall:EasyRoom3V1" ~-7 ~1 ~-7
# // - Scores -
# // buttons
