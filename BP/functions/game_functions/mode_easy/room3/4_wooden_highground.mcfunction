...
# // Level
execute as @e[type=brr:flood_room, name=easy_room3] at @s if score loaded3 easy matches 0 run structure load mystructure:EasyRoom3V4 ~-7 ~1 ~-7
# // Exit Room Anchor
# soon
# // - Scores -
# // buttons
...
# // Level
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load mystructure:EasyTunnel ~ ~1 ~-14
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load mystructure:EasyRoom3V4 ~-7 ~1 ~-7
# // - Scores -
# // buttons
