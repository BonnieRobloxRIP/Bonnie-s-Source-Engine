...
execute as @s[type=brr:flood_room, name=easy_room2_anchor] at @s if score loaded3 easy matches 0 run summon brr:flood_room ^2 ^-3 ^8 0 0 * easy_room3
...
# // Level
execute as @e[type=brr:flood_room, name=easy_room3] at @s if score loaded3 easy matches 0 run structure load "easy/room3/3_power_core:EasyRoom3V3" ~-7 ~1 ~-7
# // Exit Room Anchor
execute as @e[type=brr:flood_room, name=easy_room3] at @s if score loaded3 easy matches 0 run summon brr:flood_room ^9 ^19 ^3 0 0 * easy_room3_anchor
# // - Scores -
# // buttons
...
# // special
execute as @e[type=brr:flood_room, name=easy_room3] at @s if score loaded3 easy matches 0 run scoreboard players set core1 easy 0
# // = End =
...
# // Level
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "easy:EasyTunnel" ~-3 ~2 ~-14
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "easy/room3/3_power_core:EasyRoom3V3" ~-7 ~1 ~-7
# // - Scores -
# // buttons
...
# // special
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run scoreboard players set core1 endless 0
# // tp player to start
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run tp @a[tag=endless] ^-1.5 ^3 ^-11 facing ^-1.5 ^3 ^-8
