...
# // Level
execute as @e[type=brr:flood_room, name=easy_room2] at @s if score loaded2 easy matches 0 run structure load "easy/room2/2_limited_time:EasyRoom2V2" ~-7 ~1 ~-7
# // Next Room Anchor
execute as @e[type=brr:flood_room, name=easy_room2] at @s if score loaded2 easy matches 0 run summon brr:flood_room ^-5 ^19 ^14 0 0 * easy_room2_anchor
# // - Scores -
# // buttons
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "easy/room2/2_limited_time:EasyRoom2V2" ~-7 ~1 ~-7
# // - Scores -
# // buttons
