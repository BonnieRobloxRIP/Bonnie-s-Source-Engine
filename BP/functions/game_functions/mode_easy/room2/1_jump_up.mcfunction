...
execute as @s[type=brr:flood_room, name=easy_room1_anchor] at @s if score loaded2 easy matches 0 run summon brr:flood_room ^3 ^-4 ^8 0 0 * easy_room2
...
# // Level
execute as @e[type=brr:flood_room, name=easy_room2] at @s if score loaded2 easy matches 0 run structure load "easy/room2/1_jump_up:EasyRoom2V1" ~-7 ~1 ~-7
# // Next Room Anchor
...
# // Level
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "easy:EasyTunnel" ~-4 ~3 ~-14
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "easy/room2/1_jump_up:EasyRoom2V1" ~-7 ~1 ~-7
# // - Scores -
# // buttons
...
# // tp player to start
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run tp @a[tag=endless] ^-2.5 ^4 ^-11 facing ^-2.5 ^4 ^-8
