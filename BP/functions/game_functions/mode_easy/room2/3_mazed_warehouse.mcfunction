...
# // Level
execute as @e[type=brr:flood_room, name=easy_room2] at @s if score loaded2 easy matches 0 run structure load "easy/room2/3_mazed_warehouse:EasyRoom2V3" ~-7 ~1 ~-7
# // Next Room Anchor
...
# // Level
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "easy:EasyTunnel" ~-4 ~1 ~-14
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "easy/room2/3_mazed_warehouse:EasyRoom2V3" ~-7 ~1 ~-7
# // - Scores -
# // buttons
