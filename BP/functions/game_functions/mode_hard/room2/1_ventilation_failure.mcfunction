...
# // Level
execute as @e[type=brr:flood_room, name=hard_room2] at @s if score loaded2 hard matches 0 run structure load "hard/room2/1_ventilation_failure:HardRoom2V1" ~-14 ~1 ~-7
# // Next Room Anchor
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "hard/room2/1_ventilation_failure:HardRoom2V1" ~-14 ~1 ~-7
# // - Scores -
# // buttons
