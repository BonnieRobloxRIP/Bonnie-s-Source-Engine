# = LOADING =
# // Level
execute as @s[type=brr:flood_room, name=hard_room1] at @s if score loaded1 hard matches 0 run structure load "hard/room1/2_interesting_paths:HardRoom1V2" ~-14 ~1 ~-7
# // Next Room Anchor
...
execute as @s[type=brr:flood_room, name=hard_room1] at @s if score loaded1 hard matches 0 run scoreboard players add R1B4 hard 0
execute as @s[type=brr:flood_room, name=hard_room1] at @s if score loaded1 hard matches 0 run scoreboard players add R1B5 hard 0
execute as @s[type=brr:flood_room, name=hard_room1] at @s if score loaded1 hard matches 0 run scoreboard players add R1B6 hard 0
# // essential
...
execute as @s[type=brr:flood_room, name=endless] at @s if score loaded endless matches 0 run structure load "hard/room1/2_interesting_paths:HardRoom1V2" ~-14 ~1 ~-7
# // - Scores -
# // buttons
