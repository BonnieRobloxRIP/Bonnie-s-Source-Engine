...
scoreboard players random difficulty endless 1 3
# // Room
...
# // Level = easy
execute if score difficulty endless matches 1 if score room endless matches 1 run scoreboard players random variant endless 1 5
...
# // Level = hard
execute if score difficulty endless matches 3 if score room endless matches 1 run scoreboard players random variant endless 1 2
execute if score difficulty endless matches 3 if score room endless matches 2 run scoreboard players random variant endless 1 2
execute if score difficulty endless matches 3 if score room endless matches 3 run scoreboard players random variant endless 1 2
# = SCORES =
execute if score difficulty endless matches 1 if score room endless matches 1..3 run scoreboard players set endless_timer_s endless 31
...
execute if score difficulty endless matches 1 if score room endless matches 1 if score variant endless matches 5 as @e[type=brr:flood_room, name=endless] at @s run function game_functions/mode_easy/room1/5_cb_box_trot
# // room 2
...
# // Hard
# // room 1
execute if score difficulty endless matches 3 if score room endless matches 1 if score variant endless matches 1 as @e[type=brr:flood_room, name=endless] at @s run function game_functions/mode_hard/room1/1_trapped
execute if score difficulty endless matches 3 if score room endless matches 1 if score variant endless matches 2 as @e[type=brr:flood_room, name=endless] at @s run function game_functions/mode_hard/room1/2_interesting_paths
# // room 2
execute if score difficulty endless matches 3 if score room endless matches 2 if score variant endless matches 1 as @e[type=brr:flood_room, name=endless] at @s run function game_functions/mode_hard/room2/1_ventilation_failure
execute if score difficulty endless matches 3 if score room endless matches 2 if score variant endless matches 2 as @e[type=brr:flood_room, name=endless] at @s run function game_functions/mode_hard/room2/2_broken_system
# // room 3
execute if score difficulty endless matches 3 if score room endless matches 3 if score variant endless matches 1 as @e[type=brr:flood_room, name=endless] at @s run function game_functions/mode_hard/room3/1_master_lift
execute if score difficulty endless matches 3 if score room endless matches 3 if score variant endless matches 2 as @e[type=brr:flood_room, name=endless] at @s run function game_functions/mode_hard/room3/2_tesla_power