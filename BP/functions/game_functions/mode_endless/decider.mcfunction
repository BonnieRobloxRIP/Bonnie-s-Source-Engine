...
# // Level
execute if score difficulty endless matches 1 if score room endless matches 1 run scoreboard players random variant endless 1 3
...
execute if score difficulty endless matches 1 if score room endless matches 3 run scoreboard players random variant endless 1 2
# = SCORES =
...
execute if score difficulty endless matches 1 if score room endless matches 2 if score variant endless matches 3 as @e[type=brr:flood_room, name=endless] at @s run function game_functions/mode_easy/room2/3_no_exit
...
execute if score difficulty endless matches 1 if score room endless matches 3 if score variant endless matches 2 as @e[type=brr:flood_room, name=endless] at @s run function game_functions/mode_easy/room3/2_pipeline
