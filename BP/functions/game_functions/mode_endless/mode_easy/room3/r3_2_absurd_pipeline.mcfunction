# = SYSTEM RUN =
# - Open entrance door -
execute as @s[type=brr:flood_room, name=endless] at @s if score started endless matches 1 if score endless_timer_s endless matches 31 if score endless_timer_ms endless matches 1 run structure load "easy:EasyTunnelDoor2"  ~-2 ~2 ~-8
execute as @s[type=brr:flood_room, name=endless] at @s if score started endless matches 1 if score endless_timer_s endless matches 31 if score endless_timer_ms endless matches 10 run structure load "easy:EasyTunnelDoor3" ~-2 ~2 ~-8
...
# - Level title -
execute as @a[tag=endless] at @s if score endless_timer_s endless matches 31 if score endless_timer_ms endless matches 10 if score started endless matches 1 run title @a[tag=endless] subtitle §2Pipeline
