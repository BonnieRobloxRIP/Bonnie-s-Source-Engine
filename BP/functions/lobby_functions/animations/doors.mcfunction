...
execute if score doorleft lobby matches 1 run structure load "lobby/doors:LobbyDoor2" 5 89 31
...
execute if score doorleft lobby matches 5 run structure load "lobby/doors:LobbyDoor3" 5 89 31
execute if score doorleft lobby matches 5 run scoreboard players set LobbyDoorLeft lobby 2
execute if score doorleft2 lobby matches 1 run structure load "lobby/doors:LobbyDoor2" 5 89 31
...
execute if score doorleft2 lobby matches 5 run structure load "lobby/doors:LobbyDoor1" 5 89 31
...
execute if score doorright lobby matches 1 run structure load "lobby/doors:LobbyDoor2" -11 89 31
...
execute if score doorright lobby matches 5 run structure load "lobby/doors:LobbyDoor3" -11 89 31
execute if score doorright lobby matches 5 run scoreboard players set LobbyDoorRight lobby 2
execute if score doorright2 lobby matches 1 run structure load "lobby/doors:LobbyDoor2" -11 89 31
...
execute if score doorright2 lobby matches 5 run structure load "lobby/doors:LobbyDoor1" -11 89 31
...
execute if score ecdoor1 lobby matches 3 run structure load "lobby/doors:ExtremeCenterDoor1a" -22 94 -19
execute if score ecdoor1 lobby matches 5 run structure load "lobby/doors:ExtremeCenterDoor1a" -22 93 -19
execute if score ecdoor1 lobby matches 7 run structure load "lobby/doors:ExtremeCenterDoor1a" -22 92 -19
