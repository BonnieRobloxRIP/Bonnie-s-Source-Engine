...
# // Hard Mode
execute as @a[tag=hard_music, tag=!music_stop, scores={music=..-1}] at @s if score soundtrack hard matches 1 run playsound music.hardgame @s
execute as @a[tag=hard_music, tag=!music_stop, scores={music=..-1}] at @s if score soundtrack hard matches 1 run scoreboard players set @s music 2938
execute as @a[tag=hard_music, tag=!music_stop, scores={music=..-1}] at @s if score soundtrack hard matches 2 run playsound music.hardgame2 @s
execute as @a[tag=hard_music, tag=!music_stop, scores={music=..-1}] at @s if score soundtrack hard matches 2 run scoreboard players set @s music 7102
# // Extreme Mode
...
execute as @a[tag=music_stop] at @s run stopsound @s music.hardgame2
...
execute as @a[tag=!hard_music, tag=!endless_music] at @s run stopsound @s music.hardgame2
execute as @a[tag=!extreme_music, tag=!endless_music] at @s run stopsound @s music.extremegame


# = ENDLESS MUSIC PICKER =
# - SCORE -
execute as @a[tag=endless_music, tag=!music_stop, scores={music=..-1}] at @s run scoreboard players random @s lobby 1 5
...
execute as @a[tag=endless_music, tag=!music_stop, scores={music=..-1, lobby=4}] at @s run playsound music.hardgame2 @s
execute as @a[tag=endless_music, tag=!music_stop, scores={music=..-1, lobby=4}] at @s run scoreboard players set @s music 7102
execute as @a[tag=endless_music, tag=!music_stop, scores={music=..-1, lobby=5}] at @s run playsound music.extremegame @s
execute as @a[tag=endless_music, tag=!music_stop, scores={music=..-1, lobby=5}] at @s run scoreboard players set @s music 2914
