...
execute as @a[x=0, y=86, z=-16, dx=0, dy=0, dz=0, tag=!host] at @s run gamemode a @s
execute as @a[x=0, y=86, z=-16, dx=0, dy=0, dz=0] at @s run scoreboard players reset @s music
execute as @a[x=0, y=86, z=-16, dx=0, dy=0, dz=0] at @s run tag @s remove spectator
...
execute as @a[x=0, y=86, z=-16, dx=0, dy=0, dz=0] at @s run tag @s remove easytunnel5
...
execute as @a[x=0, y=86, z=-16, dx=0, dy=0, dz=0] at @s run tag @s remove mediumtunnel5
...
execute as @a[x=0, y=86, z=-16, dx=0, dy=0, dz=0] at @s run tag @s remove hardtunnel5
