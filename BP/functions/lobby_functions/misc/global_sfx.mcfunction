...
execute if score metal lobby matches 6 run playsound sfx.ambiance.metal.6 @a
execute if score metal lobby matches 7 run playsound sfx.ambiance.metal.7 @a
